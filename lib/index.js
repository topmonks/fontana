...
function convert(fontConfig, glyphsPath) {
  return new Promise((resolve, reject) => {
    ...
    fontConfig.glyphs.forEach((glyphData) => {
      const glyph = fs.createReadStream(path.join(glyphsPath, `${glyphData.file}.svg`));
...
exports.generate = function (param) {
  const { fontConfig, outputPath, glyphsPath, fontSpecimen } = param;
...
exports.generateAll = function() {
  ...
  convert(fontConfig, 'icons').then((svgFont) => {
